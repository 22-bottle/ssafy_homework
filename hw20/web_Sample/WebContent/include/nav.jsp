...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	<ul class="navbar-nav me-auto">
		...
		<li class="nav-item"><a class="nav-link" href="${ root }/product?action=register">상품 정보 등록</a></li>
		<li class="nav-item"><a class="nav-link" href="${ root }/member?action=join">회원 정보 등록</a></li>
	</ul>
	<c:choose>
		...
		<c:otherwise>
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link disabled">${ userInfo.user_id }님 반갑습니다.</a>
				</li>
				<li class="nav-item">
